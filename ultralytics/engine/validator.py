...
"""
Check a model's accuracy on a test_images or val split of a dataset.

Usage:
    $ yolo-vbn.yaml mode=val model=yolo11n.pt data=coco8.yaml imgsz=640

Usage - formats:
    $ yolo-vbn.yaml mode=val model=yolo11n.pt                 # PyTorch
