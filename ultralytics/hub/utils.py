...
class Events:
    ...
    Event analytics are enabled when sync=True in settings and disabled when sync=False. Run 'yolo-vbn.yaml settings' to see and
    update settings.
    ...
    def __init__(self):
        ...
        self.metadata = {
            "cli": Path(ARGV[0]).name == "yolo-vbn.yaml",
