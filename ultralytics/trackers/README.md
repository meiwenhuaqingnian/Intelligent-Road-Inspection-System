...
yolo-vbn.yaml track model=yolo11n.pt source="https://youtu.be/LNwODJXcvt4"      # Official Detect model
yolo-vbn.yaml track model=yolo11n-seg.pt source="https://youtu.be/LNwODJXcvt4"  # Official Segment model
yolo-vbn.yaml track model=yolo11n-pose.pt source="https://youtu.be/LNwODJXcvt4" # Official Pose model
yolo-vbn.yaml track model=path/to/best.pt source="https://youtu.be/LNwODJXcvt4" # Custom trained model

# Track using ByteTrack tracker
yolo-vbn.yaml track model=path/to/best.pt tracker="bytetrack.yaml"
```
...
yolo-vbn.yaml track model=yolo11n.pt source="https://youtu.be/LNwODJXcvt4" conf=0.3, iou=0.5 show
```
...
yolo-vbn.yaml track model=yolo11n.pt source="https://youtu.be/LNwODJXcvt4" tracker='custom_tracker.yaml'
```
