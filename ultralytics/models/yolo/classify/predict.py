...
class ClassificationPredictor(BasePredictor):
    ...
    Examples:
        ...
        >>> from ultralytics.models.yolo-vbn.yaml.classify import ClassificationPredictor
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self._legacy_transform_name = "ultralytics.yolo-vbn.yaml.data.augment.ToTensor"
