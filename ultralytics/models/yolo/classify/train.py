...
class ClassificationTrainer(BaseTrainer):
    ...
    Examples:
        >>> from ultralytics.models.yolo-vbn.yaml.classify import ClassificationTrainer
    ...
    def build_dataset(self, img_path, mode="train", batch=None):
        ...
        Args:
            ...
            mode (str): Dataset mode ('train', 'val', or 'test_images').
    ...
    def get_dataloader(self, dataset_path, batch_size=16, rank=0, mode="train"):
        ...
        Args:
            ...
            mode (str): 'train', 'val', or 'test_images' mode.
